      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-end">
        {onStartTour && (
          <button
            ...
            className="hidden sm:flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80 transition-colors text-xs sm:text-sm cursor-pointer"
          >
