...
const S3_REGION = process.env.AWS_REGION || process.env.AWS_DEFAULT_REGION || "eu-central-1";
// Initialize S3 client
const s3Client = new client_s3_1.S3Client({ region: S3_REGION });
/**
...
const handler = async (event) => {
    try {
        ...
        const fileKey = `images/${(0, uuid_1.v4)()}.${fileExtension}`;
        // Upload to S3
